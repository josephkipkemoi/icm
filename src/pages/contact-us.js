        ...
        <div className="container mt-5 mb-5 contact-container">
            <div className="row">
                <div className="col-sm">
                    ...
                    <p className="mt-4">
                        We’d be delighted to host you at our office for a conversation. We look forward to welcoming you
                    </p>
                    <div>
                        <div className="d-flex align-items-start">
                            <FontAwesomeIcon className="m-2" size="md" icon={faLocation}/>
                            <p className="m-1">Milimani Apartment G4, Lena Moi Road, Nakuru Kenya</p>
                        </div>
                        <div className="d-flex align-items-start mt-4">
                            <FontAwesomeIcon className="m-2" size="md" icon={faPhone}/>
                            <p className="m-1">
                                Tel: +254-795-216-873 / +254-704-734-454                       
                            </p>                            
                        </div>
                        <div className="d-flex align-items-start mt-4">
                        <FontAwesomeIcon className="m-2" size="md" icon={faPhoneFlip}/>
                            <p className="m-1">
                                WhatsApp No:
                                +254-795-216-873                 
                            </p>
                        ...
                        <div className="d-flex align-items-start mt-4">
                            <FontAwesomeIcon className="m-2" size="md" icon={faMessage}/>
                            <p className="m-1">
                                 Email: info@icm.co.ke                          
                            </p>
                        </div>     
                        <div className="d-flex align-items-start mt-4">
                            <FontAwesomeIcon className="m-2" size="md" icon={faClock}/>
                            <p className="m-1">
                                Mon - Friday: 8:00 AM to 5:00 PM   <br/>
                                Sat, Sunday & Public Holidays: Closed                  
                            </p>
                        </div>    
                        <div className="mt-5">
...
const ContactFormComponent = () => {
    ...
    const validateInput = () => {
        if (name === "" ||  email == "" ||  message === "") {
            setValidationError(prev => prev.concat("Please fill in all input fields below."))
        }
    }
    ...
    <div  className="col-sm">
        ...
        {validationError.length > 0 && validationError.map((v,i) => <p key={i+v} className="alert alert-danger d-flex justify-content-between border-0"><span>{v}</span> <span onClick={() => setValidationError([])}>x</span></p>)}
        <div className="mt-3">
...
const GeoLocationComponent = () => {
    return (
        <div className="google-map text-center">
            <hr/>
            <h4>Google Map</h4>
